...
public abstract class Dialect {
	...
	public List<Record> takeOverDbPaginateList(Connection conn, int pageNumber, int pageSize, Boolean isGroupBySql, String sql, Object... paras) throws SQLException {
